                ...
                <div class="mt-5">
                    ...
                    <div class="card-body text-center">
                        <form action="loginphp.php" method="POST">
                            <input type="text" placeholder=" Username " name="user" classname="form-control mb-5">
                            <input type="password" placeholder=" Password " name="pass" classname="form-control mb-5">
